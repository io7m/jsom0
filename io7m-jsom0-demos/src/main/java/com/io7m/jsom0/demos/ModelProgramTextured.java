...
public final class ModelProgramTextured extends ModelProgram
{
  private final Program program;

  public ModelProgramTextured(
    final @Nonnull Log log)
    throws ConstraintError
  {
    this.program = new Program("textured", log);
  }
      ...
      GLException
  {
    ...
    Constraints.constrainNotNull(u, "Uniform");
    gl.programPutUniformTextureUnit(u, unit);
  }
